    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                NText {
                    text: "Show active provider, cycle between enabled providers, or fix a specific one"
            ...
            ColumnLayout {
                visible: (editSettings?.barDisplayMode ?? "active") === "fixed"
                Layout.fillWidth: true
                spacing: Style.marginXS
                ...
                NText {
                    text: "Always show this provider in the bar"
                    pointSize: Style.fontSizeXS
                    color: Color.mOnSurfaceVariant
                }
                ...
                NComboBox {
                    ...
                    currentKey: editSettings?.barFixedProviderId ?? ""
                    onSelected: key => {
                        editSettings.barFixedProviderId = key;
                    }
                }
            }
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    spacing: Style.marginM
                    NToggle {
                        checked: editSettings?.providers?.deepseek?.enabled ?? false
                        onToggled: value => {
                            if (!editSettings.providers)
                                editSettings.providers = {};
                            if (!editSettings.providers.deepseek)
                                editSettings.providers.deepseek = {};
                            editSettings.providers.deepseek.enabled = value;
                            editSettingsChanged();
                        }
                    }
                    NText {
                ...
                NTextInput {
                    visible: editSettings?.providers?.deepseek?.enabled ?? false
                    Layout.fillWidth: true
                    Layout.leftMargin: Style.marginXL
